...
class LivraisonController extends AbstractController
{
     ...
     */
    function Ajouter(Request $request,PersonneRepository $personneRepository, CommandeRepository $commandeRepository){
        ...
        if (!$session->has('id')) {
            ...
            $idcommande = $this->getDoctrine()->getRepository(Commande::class)->findOneBy([
                'idclient'=>$idd
            ]);
