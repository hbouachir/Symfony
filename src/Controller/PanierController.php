...
class PanierController extends AbstractController
{
     ...
     * @return Response
     */
    public function commandeConfirmer(CommandeRepository $commandeRepository, ProduitRepository $produitRepository, Request $request)
    {
...
//        $session->set('total', null);}
        ...
        return $this->redirectToRoute('add', [], Response::HTTP_SEE_OTHER);
